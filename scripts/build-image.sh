...
EXTRA_PACKAGES="${EXTRA_PACKAGES:-luci luci-i18n-base-zh-cn luci-i18n-package-manager-zh-cn luci-app-daede luci-app-ddns-go luci-i18n-ddns-go-zh-cn luci-app-dockerman luci-i18n-dockerman-zh-cn  luci-app-passwall luci-i18n-passwall-zh-cn luci-app-uhttpd luci-i18n-uhttpd-zh-cn kmod-sched-core kmod-sched-bpf kmod-veth kmod-xdp-sockets-diag curl nano}"
